...
# Roles whose presence on a user implies User.is_admin = True.
# Kept in sync with the RBAC seed matrix. Used by RBACService._sync_is_admin
# and the backfill migration. Do NOT modify without updating the migration.
