...
const STATIC_PLANS: Plan[] = [
  {
    ...
    byok_note: "Todos los modelos incluidos con la plataforma. Sin necesidad de API key.",
    cta: "Tu plan actual",
    cta_disabled: true,
    highlighted: false,
  },
...
export default function BillingPage() {
  ...
  const handleCheckout = async (planId: string) => {
    ...
    try {
      const res = await authFetch(`/api/billing/${orgId}/checkout`, {
        method: "POST",
