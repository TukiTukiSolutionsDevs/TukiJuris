...
interface NotificationBellProps {
  ...
  token: string | null;
  /** Optional className that fully replaces the default bell button styling. */
  buttonClassName?: string;
}

export default function NotificationBell({ token, buttonClassName }: NotificationBellProps) {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      <button
        ...
        className={`relative ${
          buttonClassName ??
          "inline-flex h-9 w-9 items-center justify-center rounded-lg border border-outline-variant bg-transparent text-on-surface-variant transition-colors hover:border-outline hover:text-on-surface-strong"
        }`}
      ...
      >
        ...
        {unreadCount > 0 && (
          <span className="absolute -right-0.5 -top-0.5 inline-flex h-[15px] min-w-[15px] items-center justify-center rounded-full border-2 border-background bg-status-danger px-1 text-[9px] font-bold leading-none text-white">
